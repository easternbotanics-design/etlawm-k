      ...
      >
        ...
        <g transform="translate(2,2)">
          ...
          <g transform="translate(13.75,9.25)" className="loader__model">
            ...
            <rect height={2} width="24.5" fill="000000" />
            <rect height={1} width="19.5" y="0.5" x="2.5" ry="0.5" rx="0.5" fill="000000" />
            <rect height={2} width="24.5" y="31.5" fill="000000" />
            <rect height={1} width="19.5" y={32} x="2.5" ry="0.5" rx="0.5" fill="000000" />
          </g>
        </g>
      </svg>

      <style>{`
        .hourglass-loader-wrapper {
          --hue: 223;
          display: contents;
        }
        .loader {
        ...
        .loader__glare-top { animation-name: hourglass-glare-top; }
        .loader__glare-bottom { animation-name: hourglass-glare-bottom; }
        .loader__model {
        ...
        .loader__motion-thick { animation-name: hourglass-motion-thick; }
        .loader__motion-medium { animation-name: hourglass-motion-medium; }
        .loader__motion-thin { animation-name: hourglass-motion-thin; }
        .loader__sand-drop { animation-name: hourglass-sand-drop; }
        .loader__sand-fill { animation-name: hourglass-sand-fill; }
        .loader__sand-grain-left { animation-name: hourglass-sand-grain-left; }
        .loader__sand-grain-right { animation-name: hourglass-sand-grain-right; }
        .loader__sand-line-left { animation-name: hourglass-sand-line-left; }
        .loader__sand-line-right { animation-name: hourglass-sand-line-right; }
        .loader__sand-mound-top { animation-name: hourglass-sand-mound-top; }
        .loader__sand-mound-bottom {
