  ...
  return (
    <div className="fixed inset-0 w-screen h-screen">
      <div
        ...
        className={`relative w-full h-full bg-white border-8 border-black overflow-hidden select-none box-border ${
      ...
      >
        ...
        {/* Nameplate — fixed position, content follows the active seat.
            On desktop it sits directly on top of the content box (same
            left edge), rather than floating beside the wheel. */}
        <div
          className={`absolute rounded bg-neutral-300 flex items-center justify-center font-medium text-neutral-600 tracking-wide ${
